...
class PoItem {
  List<PoItemList>? listpoitem;
  Pageable? pageable;

  PoItem({this.listpoitem, this.pageable});

  PoItem.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      listpoitem = <PoItemList>[];
      json['content'].forEach((v) {
        listpoitem!.add(new PoItemList.fromJson(v));
      });
    }
...
class PoItemList {
  ...
  int? remaining;
  int? totalCost;
  WarehouseItemPo? warehouse;
  WarehouseItemPo? suplier;
  ExpensesItemPo? expenses;
  List<ItemsPo>? items;
  ...
  PoItemList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    note = json['note'];
    ...
    warehouse = json['warehouse'] != null
        ? new WarehouseItemPo.fromJson(json['warehouse'])
        : null;
    suplier = json['suplier'] != null
        ? new WarehouseItemPo.fromJson(json['suplier'])
        : null;
    expenses = json['expenses'] != null
        ? new ExpensesItemPo.fromJson(json['expenses'])
        : null;
    if (json['items'] != null) {
      items = <ItemsPo>[];
...
class WarehouseItemPo {
  String? name;

  WarehouseItemPo({this.name});

  WarehouseItemPo.fromJson(Map<String, dynamic> json) {
    name = json['name'];
  }
...
class ExpensesItemPo {
  String? status;
  String? type;

  ExpensesItemPo({this.status, this.type});

  ExpensesItemPo.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    type = json['type'];
  }
