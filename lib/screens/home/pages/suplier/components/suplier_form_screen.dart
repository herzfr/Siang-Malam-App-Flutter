...
class SuplierFormScreen extends StatelessWidget {
  static String routeName = "/suplier/form";
  const SuplierFormScreen({Key? key}) : super(key: key);
...
class SuplierForm extends GetView<SuplierFormController> {
  const SuplierForm({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
        ...
        child: Column(
          children: [
            ...
            CustomInputFieldWithController(
              ...
              dataInstance: (String? val) {},
              validationBuilder:
                  ValidationBuilder().email(min3inputVldMsg).build(),
            ),
            SizedBox(height: 3.h),
            CustomButton(
              text: btnSaveTxt,
