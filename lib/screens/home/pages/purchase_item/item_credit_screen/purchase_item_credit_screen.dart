...
class PurchaseItemCreditScreen extends GetView<PoItemCreditControllerV2> {
  static String routeName = " /v2/po-item/credit";
  PurchaseItemCreditScreen({Key? key}) : super(key: key);
  ...
  bodyMode(BuildContext context) {
    if (controller.listPoitem.value.paidStatus == 'DONE') {
      return body(context);
    } else {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      child: Obx(() =>
                          controller.detailPurchasing.value.purchaseItem != null
                              ? Text(
                                  'Sisa ${controller.convertPrice(controller.detailPurchasing.value.purchaseItem!.remaining ?? 0)}',
      ...
      title: Row(
        ...
        children: [
          Expanded(
            // flex: 7,
            child: Text(
              "Angsuran " + controller.listPoitem.value.note!,
