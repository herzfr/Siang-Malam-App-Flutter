...
class DateFilterPanel extends GetView<AttendanceHistoryController> {
                  ...
                  Row(
                    children: [
                      Text(
                        ...
                        style: TextStyle(color: mtGrey700, fontWeight: FontWeight.w500, fontSize: 11.sp),
                      ),
                      const Icon(
                      ...
                      Text(
                        ...
                        style: const TextStyle(color: mtGrey700, fontWeight: FontWeight.w500),
                      ),
                    ],
                  )
                ],
