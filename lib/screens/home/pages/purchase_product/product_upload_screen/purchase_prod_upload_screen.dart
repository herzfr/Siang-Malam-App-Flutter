...
class PurchaseProductUploadScreen extends GetView<PoUploadController> {
  static String routeName = " /v2/po-pruduct/upload";
  PurchaseProductUploadScreen({Key? key}) : super(key: key);
    ...
    return Container(
        ...
        child: Column(children: [
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    child: Obx(
                      () {
                        if (controller.listPoproduct.value.proofPic != null) {
                          return Image(
                            image: CachedNetworkImageProvider(
                                controller.listPoproduct.value.proofPic!),
                          );
                        } else {
          ...
          Obx(
            () {
              if (controller.imageProof.value.fileName.isNotEmpty ||
                  controller.listPoproduct.value.proofPic != null) {
