...
class PurchaseProductFormScreen extends GetView<PoProductFormControllerV2> {
  static String routeName = "v2/po-item/form";
  const PurchaseProductFormScreen({Key? key}) : super(key: key);
  ...
  Widget panelF(BuildContext context) {
    if (controller.listPoproduct.value.status != 'DONE') {
          ...
          children: [
              ...
              () => controller.warehouseDD.isNotEmpty
                  ? Padding(
                      ...
                      child: DropdownButtonFormField<int>(
                        ...
                        value: controller.listPoproduct.value.warehouseId,
                        decoration: CustomFormWidget.customInputDecoration(
                            '', 'Dapur/Gudang'),
                        onChanged: controller.listPoproduct.value.status !=
                                'DONE'
                            ? (value) => {
                                  controller.listPoproduct.value.warehouseId =
                                      value,
                                  controller.listPoproduct.refresh()
                                }
                            : null,
                      ),
                    )
              ...
              () => controller.warehouseDD.isNotEmpty
                  ? Padding(
                      ...
                      child: DropdownButtonFormField<int>(
                        ...
                        value: controller.listPoproduct.value.suplierId,
                        decoration: CustomFormWidget.customInputDecoration(
                            '', 'Suplier'),
                        onChanged:
                            controller.listPoproduct.value.status != 'DONE'
                                ? (value) => {
                                      controller.listPoproduct.value.suplierId =
                                          value,
                                      controller.listPoproduct.refresh()
                                    }
                                : null,
            ...
            Form(
              ...
              child: Padding(
                ...
                child: CustomInputFieldWithControllerSingleFocus(
                  ...
                  label: "Catatan",
                  enable: controller.listPoproduct.value.status != 'DONE',
                  icon: Icons.edit,
                  node: node,
            ...
            Expanded(
              child: Container(
                color: Colors.transparent,
                child: Padding(
                    padding: controller.listPoproduct.value.status != 'DONE'
                        ? EdgeInsets.only(bottom: 10.h)
                        : EdgeInsets.only(bottom: 0.h),
                    child: Obx(
                      () => controller.listPoproduct.value.products != null
                          ? ListView.builder(
                              itemCount: controller
                                  .listPoproduct.value.products!.length,
                              itemBuilder: (_, int i) => ListTile(
                                  title: Row(
                                    mainAxisAlignment: MainAxisAlignment.end,
                                    children: <Widget>[
                                      Text(controller.listPoproduct.value
                                          .products![i].name!),
                                      const SizedBox(width: 8),
                                      TextButton(
                                        child: const Text('HAPUS'),
                                        onPressed: controller.listPoproduct
                                                    .value.status !=
                                                'DONE'
                                            ? () {
                                                controller.delete(i);
                                        ...
                                        children: [
                                          Expanded(
                                            ...
                                            child: TextField(
                                              ...
                                              enabled: controller.listPoproduct
                                                      .value.status !=
                                                  'DONE',
                                              keyboardType:
  ...
  //     itemCount: controller.listPoproduct.value.products != null
      ...
      title: Row(
        ...
        children: [
          ...
          Expanded(
              ...
              child: Obx(
                () => controller.listPoproduct.value.products != null &&
                        controller.listPoproduct.value.products!.isNotEmpty &&
                        controller.listPoproduct.value.status != 'DONE'
  ...
  TextButton generateSubmitButton() {
    return TextButton(
      ...
      onPressed: controller.listPoproduct.value.products != null &&
              controller.listPoproduct.value.products!.isNotEmpty &&
              controller.listPoproduct.value.status != 'DONE'
          ? () {
