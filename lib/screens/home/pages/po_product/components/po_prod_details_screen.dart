...
import 'package:siangmalam/screens/home/pages/po_product/components/panel/po_prod_pic.dart';
import 'package:siangmalam/widgets/custom_input.dart';
import 'package:sizer/sizer.dart';

class DetailsPoProductScreen extends GetView<PoProductDetailsController> {
  static String routeName = "/po-product/details";
  const DetailsPoProductScreen({Key? key}) : super(key: key);
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        child: Text(
                                          '${controller.poproductlist.value.products?.length}',
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () =>
                                      controller.poproductlist.value.products ==
                                              null
                                          ? const Text(
                                              'Data Produk Kosong',
                                              textScaleFactor: 1,
                              ...
                              Padding(
                                ...
                                child: Obx(
                                  () => TextFormField(
                                      enabled: controller.poproductlist.value
                                                      .status ==
                                                  'DONE' ||
                                              controller.poproductlist.value
                                                      .status ==
                                                  'CANCEL'
                                          ? false
                                          : true,
                                      ...
                                      onFieldSubmitted: (value) {
                                        controller.controllersNote.value.text =
                                            value;
                                        controller.poproductlist.value.note =
                                            value;
                                      },
                                      onChanged: (value) => {
                                            // controller.controllersNote.value.text =
                                      ...
                                      Expanded(
                                        ...
                                        child: SizedBox(
                                          child: ElevatedButton(
                                            ...
                                            onPressed: controller.poproductlist
                                                            .value.status !=
                                                        'CANCEL' &&
                                                    controller.poproductlist
                                                            .value.status !=
                                                        'DONE'
                                                ? () {
                                ...
                                child: Obx(
                                  () {
                                    return DropdownButtonFormField<String>(
                                      ...
                                      value:
                                          controller.poproductlist.value.status,
                                      decoration: CustomFormWidget
                                      ...
                                      // },
                                      onChanged: controller.poproductlist.value
                                                      .status ==
                                                  'DONE' ||
                                              controller.poproductlist.value
                                                      .status ==
                                ...
                                child: Obx(
                                  () {
                                    return DropdownButtonFormField<String>(
                                      ...
                                      value: controller
                                          .poproductlist.value.expenses?.status,
                                      decoration: CustomFormWidget
                                          .customInputDecoration(
                                              '', 'Status Pembayaran'),
                                      // onChanged: (value) {
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed:
                                      controller.whoIs.value == 'MANAGER' &&
                                              controller.poproductlist.value
                                                      .status !=
                                                  'DONE' &&
                                              controller.poproductlist.value
...
AppBar buildAppBar(PoProductDetailsController controller) {
  return AppBar(
    elevation: 0,
...
Stack getCardBuild(
    BuildContext context, PoProductDetailsController controller) {
  Size size = MediaQuery.of(context).size;
  return Stack(
    ...
    children: [
      ...
      Positioned(
        ...
        child: Container(
          ...
          height: 100,
          width: 100,
          child: getStatus(controller.poproductlist.value.status),
        ),
      ),
      Positioned(
        top: 10,
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'No. ${controller.poproductlist.value.orderNo}',
                  textScaleFactor: 1.1,
                  maxLines: 1,
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(
                  'Catatan : ${controller.poproductlist.value.note}',
                  textScaleFactor: 0.9,
                  maxLines: 1,
                  style: const TextStyle(color: Colors.black),
                ),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(
                  '${controller.poproductlist.value.warehouse?.name}',
                  textScaleFactor: 0.9,
                  maxLines: 1,
                  style: const TextStyle(color: Colors.black),
                ),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: Text(
                  'Suplier/Toko : ${controller.poproductlist.value.suplier?.name ?? ''}',
                  textScaleFactor: 0.9,
                  // maxLines: 1,
                  style: const TextStyle(color: Colors.black),
                ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              getStatusPayment(
                  controller.poproductlist.value.expenses?.status!),
            ],
          ),
        ),
      )
...
class PoItemDetails extends GetView<PoProductDetailsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => ListView.builder(
          ...
          itemCount: controller.poproductlist.value.products?.length,
          itemBuilder: (context, index) {
            controller.controllersCost.value.add(TextEditingController(
                text: controller.poproductlist.value.products?[index].cost
                    .toString()));
            controller.controllersQty.value.add(TextEditingController(
                text: controller.poproductlist.value.products?[index].quantity
                    .toString()));
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              controller.poproductlist.value.products?[index]
                                      .name ??
                                  '',
                              style: const TextStyle(
                                fontSize: 14,
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              flex: 1,
                              child: ElevatedButton(
                                onPressed: controller.poproductlist.value
                                                .products?[index].status ==
                                            'DONE' ||
                                        controller.poproductlist.value.status ==
                                            'DONE' ||
                        ...
                        child: Obx(
                          () {
                            return DropdownButtonFormField<String>(
                              ...
                              value: controller.productpo.value[index].status,
                              decoration:
                              ...
                              onChanged: controller
                                          .poproductlist.value.status ==
                                      'DONE'
                                  ? null
                                  : (value) {
                                      controller.productpo.value[index].status =
                                          value!;
                                    },
                            );
                          },
...
dialogUp(PoProductDetailsController controller, int choose) {
  switch (choose) {
    case 0:
      Get.defaultDialog(
          title: "Setuju?",
