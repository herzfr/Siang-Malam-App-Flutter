...
class FilterProductsScreen extends GetView<PoProductCreateController> {
...
Container listItemData(
    BuildContext context, PoProductCreateController controller) {
  return Container(
    child: Obx(() {
      return PagedListView<int, ProductListData>.separated(
          ...
          builderDelegate: PagedChildBuilderDelegate<ProductListData>(
            itemBuilder: (context, prod, index) => Card(
              elevation: 2,
