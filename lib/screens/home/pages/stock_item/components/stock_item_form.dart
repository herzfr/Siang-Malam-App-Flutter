...
class StockItemFormScreen extends StatelessWidget {
  static String routeName = "/stockitem/transfer";
  const StockItemFormScreen({Key? key}) : super(key: key);
...
class StockProductForm extends GetView<StockItemFormController> {
